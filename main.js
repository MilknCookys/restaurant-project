...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   clearContent: () => (/* binding */ clearContent)\n/* harmony export */ });\nfunction clearContent() {\n  const content = document.querySelector(\"#content\");\n\n  content.replaceChildren();\n}\n\n\n\n\n//# sourceURL=webpack://restaurant-project/./src/clearContent.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   renderDrinksPage: () => (/* binding */ renderDrinksPage)\n/* harmony export */ });\nfunction renderDrinksPage() {\n  const content = document.querySelector(\"#content\");\n\n  function createElementWithID(elementName, id, textContent, appendTarget) {\n    let element = document.createElement(elementName);\n    element.id = id;\n    element.textContent = textContent;\n\n    appendTarget.appendChild(element);\n\n    return element;\n  }\n\n  function createElementWithClass(\n    elementName,\n    className,\n    textContent,\n    appendTarget\n  ) {\n    let element = document.createElement(elementName);\n\n    element.classList.add(className);\n\n    element.textContent = textContent;\n\n    appendTarget.appendChild(element);\n\n    return element;\n  }\n\n  const container = createElementWithID(\"div\", \"container\", \"\", content);\n  const hotContainer = createElementWithID(\n    \"div\",\n    \"hotContainer\",\n    \"\",\n    container\n  );\n  const hot = createElementWithID(\"h1\", \"hot\", \"Hot\", hotContainer);\n  createElementWithClass(\"p\", \"description\", \"Flat White – $7\", hotContainer);\n  createElementWithClass(\n    \"p\",\n    \"description\",\n    \"Hot Chocolate – $5.50\",\n    hotContainer\n  );\n  createElementWithClass(\"p\", \"description\", \"Tea – $6\", hotContainer);\n  createElementWithClass(\"p\", \"description\", \"Chai – $10\", hotContainer);\n  createElementWithClass(\"p\", \"description\", \"Latte – $8\", hotContainer);\n  createElementWithClass(\"p\", \"description\", \"Mocha – $7.50\", hotContainer);\n  createElementWithClass(\n    \"p\",\n    \"description\",\n    \"Pumpkin Spice Latte – $9\",\n    hotContainer\n  );\n  createElementWithClass(\n    \"p\",\n    \"description\",\n    \"Matcha Latte – $8.50\",\n    hotContainer\n  );\n\n  const coldContainer = createElementWithID(\n    \"div\",\n    \"coldContainer\",\n    \"\",\n    container\n  );\n  const cold = createElementWithID(\"h1\", \"cold\", \"Cold\", coldContainer);\n  createElementWithClass(\"p\", \"description\", \"Iced Coffee – $7\", coldContainer);\n  createElementWithClass(\n    \"p\",\n    \"description\",\n    \"Cold Brew Coffee – $8\",\n    coldContainer\n  );\n  createElementWithClass(\n    \"p\",\n    \"description\",\n    \"Sweet Lychee Iced Tea – $10\",\n    coldContainer\n  );\n  createElementWithClass(\n    \"p\",\n    \"description\",\n    \"Sweet Lemon Iced Tea – $10\",\n    coldContainer\n  );\n  createElementWithClass(\n    \"p\",\n    \"description\",\n    \"Lime Milkshake – $9.50\",\n    coldContainer\n  );\n  createElementWithClass(\n    \"p\",\n    \"description\",\n    \"Caramel Milkshake – $9.50\",\n    coldContainer\n  );\n  createElementWithClass(\n    \"p\",\n    \"description\",\n    \"Iced Matcha Latte – $8.50\",\n    coldContainer\n  );\n  createElementWithClass(\n    \"p\",\n    \"description\",\n    \"Iced Chocolate – $8\",\n    coldContainer\n  );\n\n  content.setAttribute(\n    \"style\",\n    \"display:flex; justify-content:center; align-items:center;\"\n  );\n  container.setAttribute(\n    \"style\",\n    \"display:flex; justify-content:center; gap:100px; border:1px solid black; width:50%; padding:50px;\"\n  );\n\n  const descriptions = document.querySelectorAll(\".description\");\n\n  descriptions.forEach((description) => {\n    description.setAttribute(\"style\", \"margin:40px 0px;\");\n  });\n}\n\n\n\n\n//# sourceURL=webpack://restaurant-project/./src/drinks.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   renderFoodPage: () => (/* binding */ renderFoodPage)\n/* harmony export */ });\n/* harmony import */ var _clearContent_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./clearContent.js */ \"./src/clearContent.js\");\n\n\nfunction renderFoodPage() {\n  const content = document.querySelector(\"#content\");\n\n  function createElementWithID(elementName, id, textContent, appendTarget) {\n    let element = document.createElement(elementName);\n    element.id = id;\n    element.textContent = textContent;\n\n    appendTarget.appendChild(element);\n\n    return element;\n  }\n\n  function createElementWithClass(\n    elementName,\n    className,\n    textContent,\n    appendTarget\n  ) {\n    let element = document.createElement(elementName);\n\n    element.classList.add(className);\n\n    element.textContent = textContent;\n\n    appendTarget.appendChild(element);\n\n    return element;\n  }\n\n  const container = createElementWithID(\"div\", \"container\", \"\", content);\n  const breakfastContainer = createElementWithID(\n    \"div\",\n    \"breakfastContainer\",\n    \"\",\n    container\n  );\n  const breakfast = createElementWithID(\n    \"h1\",\n    \"breakfast\",\n    \"Breakfast\",\n    breakfastContainer\n  );\n  createElementWithClass(\n    \"p\",\n    \"description\",\n    \"Yallingup Wood Fired Fruit Toast, Butter, Estate Honey (vgo, dfo) – $12.5\",\n    breakfastContainer\n  );\n  createElementWithClass(\n    \"p\",\n    \"description\",\n    \"Fried Banana Banoffee Crêpes, Cinnamon Bannister Downs Chantilly Cream, Blueberry Compote (gf, dfo) – $25\",\n    breakfastContainer\n  );\n  createElementWithClass(\n    \"p\",\n    \"description\",\n    \"Poached Eggs, Hollandaise, Bacon, Woodfired Sourdough (gfo, dfo, nf, afo) – $28\",\n    breakfastContainer\n  );\n  createElementWithClass(\n    \"p\",\n    \"description\",\n    \"Scrambled Eggs, Bacon, Woodfired Sourdough (gfo, dfo, nf, af) – $28\",\n    breakfastContainer\n  );\n  createElementWithClass(\n    \"p\",\n    \"description\",\n    \"Potato Rösti, Roquette, Goats Cheese, Bush Tomato Chutney (df, nf) – $26\",\n    breakfastContainer\n  );\n\n  const lunchContainer = createElementWithID(\n    \"div\",\n    \"lunchContainer\",\n    \"\",\n    container\n  );\n  const lunch = createElementWithID(\"h1\", \"lunch\", \"Lunch\", lunchContainer);\n  createElementWithClass(\n    \"p\",\n    \"description\",\n    \"Handmade gnocchi, spinach cashew cream, wild mushrooms, black olive pangrattato (vg) – $38\",\n    lunchContainer\n  );\n  createElementWithClass(\n    \"p\",\n    \"description\",\n    \"Goldband snapper, lime leaf & lemongrass mild red curry sauce, crushed baby potato, charred bok choy, daikon red radish pickle (gf, nf, df) – $48\",\n    lunchContainer\n  );\n  createElementWithClass(\n    \"p\",\n    \"description\",\n    \"Pork belly, buttered cabbage, parsnip purée, bacon & sesame furikake, jamon cream (gf, nf) – $46\",\n    lunchContainer\n  );\n  createElementWithClass(\n    \"p\",\n    \"description\",\n    \"Prawn, scallop & white fish risotto, dill & pecorino (vo, gf, nf, dfo) – $48\",\n    lunchContainer\n  );\n  createElementWithClass(\n    \"p\",\n    \"description\",\n    \"Poached salmon winter salad, pear, blue cheese, candied walnut, mustard seed dressing, salad leaves & radicchio (gf, nfo, af, dfo, vgo) – $28\",\n    lunchContainer\n  );\n\n  const dessertContainer = createElementWithID(\n    \"div\",\n    \"dessertContainer\",\n    \"\",\n    container\n  );\n  const dessert = createElementWithID(\n    \"h1\",\n    \"dessert\",\n    \"Dessert\",\n    dessertContainer\n  );\n  createElementWithClass(\n    \"p\",\n    \"description\",\n    \"Mini honey crème brûlée, biscotti (nf, gfo) – $14\",\n    dessertContainer\n  );\n  createElementWithClass(\n    \"p\",\n    \"description\",\n    \"Wise sticky date pudding, butterscotch sauce, vanilla ice cream (nf) – $14\",\n    dessertContainer\n  );\n  createElementWithClass(\n    \"p\",\n    \"description\",\n    \"Caramel & macadamia ice cream (gf) – $4\",\n    dessertContainer\n  );\n  createElementWithClass(\n    \"p\",\n    \"description\",\n    \"Affogato, vanilla ice cream – $9\",\n    dessertContainer\n  );\n  createElementWithClass(\n    \"p\",\n    \"description\",\n    \"Warm hazelnut chocolate brownie (dfo), coconut, peanut butter & whiskey ice cream – $14\",\n    dessertContainer\n  );\n\n  content.setAttribute(\n    \"style\",\n    \"display:flex; justify-content:center; align-items:center;\"\n  );\n  container.setAttribute(\n    \"style\",\n    \"display:flex; gap:100px; border:1px solid black; width:70%; padding:50px;\"\n  );\n\n  const descriptions = document.querySelectorAll(\".description\");\n\n  descriptions.forEach((description) => {\n    description.setAttribute(\"style\", \"margin:40px 0px;\");\n  });\n}\n\n\n\n\n//# sourceURL=webpack://restaurant-project/./src/food.js?");
